...
- As a user i want to view the conmpany contact details or complete a form with my details so that I can make contact with the company should i have any queries. 
- As a user I want the website to load quickly so that i can veiw a clean and visually apealing design and have a positive user experience.  
- As a user i want the site to be responsive so that i can view the website across different devices for example desktop, laptop and mobile. 
- As a user i want to see where the company is operating from or their business address so that i 
can visit or contact the company. 
...
Gold is used for the navigation bar banner, social media banner, logo, return to home and submit buttons. The gold color compliments the black background and again allows for easily reading of content.  

Hex color code  `#EAC452`

![image](https://github.com/NBJIN/Mason-Dev/assets/106515976/968ca723-afae-4985-8b72-315a812a23bc)

White has been used for all text in the main body and footer element on each page.  Black text is used in the navigational bar, social meida banner, return to home button and submit button as there is a good contrast with black text on a yellow background.  

### d) Typography 
The main font used for this project is Raleway.  Raleway is an elegant sans-serif typeface family.

https://fonts.google.com/specimen/Raleway

The fallback fonts from Raleway are aerial and sans-serif.  
...
- Desktop Page 1 Home Page (Index Page)
...
![image](https://github.com/NBJIN/Mason-Dev/assets/106515976/0dd929d1-6f97-4624-9660-006d1d6e1244)

- Desktop Page 4 Success Page

![image](https://github.com/NBJIN/Mason-Dev/assets/106515976/3395b4c2-2534-4443-bcf8-e0b33ee60c7e)
...
- Mobile Page 4 Contact Success Page
...
Main Body - 
The main body of the specifications page contains a collage of photos showing the external and internal layout of each house type and each type have their own unique name.  
...
Header Section - 
The header section matches the three other pages in the website with same layout of logo and 
...
Footer Section - This section is as per all other pages on the website, is in the same format and 
